...
import { dailyQuotes } from "@/src/constants/quotes.js";
import { dailyMessages } from "@/src/constants/messages.js";
            ...
            <div className="welcome-banner md:col-span-2 lg:col-span-8">
              <div className="grid grid-cols-2 grid-rows-2">
                ...
                <div className="col-start-1 row-start-2 items-start flex justify-center flex-col">
                  <span className="font-normal text-xs md:text-sm opacity-90">{getDailyMessage(currentTime, dailyMessages)}</span>
                </div>
            ...
            <div className="lg:col-span-4">
              <div className="card quote-card">
                <div className="quote-content">
                  ...
                  <div className="quote-mascot">{getDailyQuote(currentTime, dailyQuotes).emoji}</div>
                  <p className="quote-text">
                    "{getDailyQuote(currentTime, dailyQuotes).text}"
                  </p>
                  <p className="quote-author">— {getDailyQuote(currentTime, dailyQuotes).author}</p>
                </div>
              </div>
            </div>
        </div>
